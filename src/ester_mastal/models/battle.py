...
class BattleEngine:
    ...
    def player_attack(self) -> List[str]:
        ...
        if random.randint(1, 16) == 1:
            ...
            damage = self.calculate_physical_damage(self.player.attack, self.monster.defense)
    ...
    def monster_turn(self) -> List[str]:
        ...
        damage = self.calculate_physical_damage(self.monster.attack, self.player.defense)
